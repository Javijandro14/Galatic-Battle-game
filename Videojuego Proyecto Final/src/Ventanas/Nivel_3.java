...
public class Nivel_3 extends JPanel implements ActionListener,KeyListener{
    /**
	 * 
	 */
    ...
    Cancionfondo = java.applet.Applet.newAudioClip(getClass().getResource("Death by Glamour (8 Bit Remix Cover Version) [Tribute to Undertale] - 8 Bit Universe.wav"));
    Cancionfondo.play();
    }
    @Override
    public void paintComponent(Graphics g){
        ...
        fondo = new ImageIcon(getClass().getResource("Nivel_Coguox.jpg"));//Nombre del Fondo del nivel
