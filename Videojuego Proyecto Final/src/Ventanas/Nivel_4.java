...
public class Nivel_4 extends JPanel implements ActionListener,KeyListener{
    /**
	 * 
	 */
    ...
    Cancionfondo = java.applet.Applet.newAudioClip(getClass().getResource("Comfortably Numb [8 Bit Tribute to Pink Floyd] - 8 Bit Universe.wav"));
    Cancionfondo.play();
    }
    @Override
    public void paintComponent(Graphics g){
        ...
        fondo = new ImageIcon(getClass().getResource("Nivel_Sebas.png"));//Nombre del Fondo del nivel
