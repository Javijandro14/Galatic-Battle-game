...
public class Nivel_2 extends JPanel implements ActionListener,KeyListener{
    /**
	 * 
	 */
    ...
    Cancionfondo = java.applet.Applet.newAudioClip(getClass().getResource("Dont Threaten Me With A Good Time (8 Bit Cover) [Tribute to Panic! At The Disco].wav"));
    Cancionfondo.play();
    }
    @Override
    public void paintComponent(Graphics g){
        ...
        fondo = new ImageIcon(getClass().getResource("Nivel_Marlon.jpg"));//Nombre del Fondo del nivel
