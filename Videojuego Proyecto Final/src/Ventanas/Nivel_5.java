...
public class Nivel_5 extends JPanel implements ActionListener,KeyListener{
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private int ox=200, oy=390, velX, velY, posX=0, Health=100, vx=0, score=0;//Jugador
    private final int ix=10000,iy=700;//Nivel Fondo
    ...
    Cancionfondo = java.applet.Applet.newAudioClip(getClass().getResource("The Offspring - Youre Gonna Go Far Kid 8-bit.wav"));
    Cancionfondo.play();
    }
    @Override
    public void paintComponent(Graphics g){
        ...
        fondo = new ImageIcon(getClass().getResource("Nivel_Osorio.png"));//Nombre del Fondo del nivel
